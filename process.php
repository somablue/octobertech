<?php
	...
	$message = '';
	$message .= '<p>Hola, ha sido registrado un nuevo mensaje desde el formulario de contacto del sitio web octobertech.cl, según el detalle siguiente:</p> ';
	...
	$email='contacto@octobertech.cl';//Ingresa tu dirección de correo
