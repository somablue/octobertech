...
jQuery(document).ready(function($) {
    ...
    $("#submit_btn").click(function() {
        ...
        if (person_name == "") {
            var error1 = '<div class="enter-name col-lg-3 align-center"> Ingrese su Nombre </div>';
        ...
        if (user_email == "") {
            var error2 = '<div class="enter-email col-lg-3 align-center"> Ingrese su E-mail </div>';
            jQuery("#result").hide().html(error2).fadeIn(500);
            proceed = false;

        } else if (!filter.test(user_email)) {
            var invalid = '<div class="invalid-email col-lg-3 align-center"> E-mail inválido </div>';
